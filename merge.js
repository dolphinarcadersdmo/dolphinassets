...
\outl0\strokewidth0 \strokec3 (function () \{\
  "use strict";\
\
  const defaultConfig = \{\
    files: [],\
...
\
    const lines = [\
      ...
      '<a href=\'93bit.ly/404dolphin\'93 style="font-size: 15px; color: #d42222; text-decoration: underline; margin-bottom: 10px; display: block;">Dolphin</a>',\
      '<a href="" style="font-size: 15px; color: #14b4f3; text-decoration: underline; margin-bottom: 10px; display: block;"></a>',\
    ];\
\
